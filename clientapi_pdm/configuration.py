...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "PDMAuthCookie": APIKeyAuthSetting,
        "CSRFPreventionToken": APIKeyAuthSetting,
        "PDMApiToken": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = clientapi_pdm.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://localhost:8443/api2/json" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("clientapi_pdm")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'PDMAuthCookie' in self.api_key:
            auth['PDMAuthCookie'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'PDMAuthCookie',
        ...
        if 'CSRFPreventionToken' in self.api_key:
            auth['CSRFPreventionToken'] = {
                'type': 'api_key',
                'in': 'header',
        ...
        if 'PDMApiToken' in self.api_key:
            auth['PDMApiToken'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
