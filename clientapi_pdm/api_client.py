...
from clientapi_pdm.api_response import ApiResponse, T as ApiResponseT
import clientapi_pdm.models
from clientapi_pdm import rest
from clientapi_pdm.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clientapi_pdm.models, klass)
