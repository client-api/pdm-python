...
class PbsRemotesGetPbsRemotesByRemoteRrddataResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cpu-avg1", "cpu-avg15", "cpu-avg5", "cpu-current", "cpu-iowait", "disk-available", "disk-read", "disk-total", "disk-used", "disk-write", "mem-total", "mem-used", "net-in", "net-out", "swap-total", "swap-used", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsRemotesGetPbsRemotesByRemoteRrddataResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsRemotesGetPbsRemotesByRemoteRrddataResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cpu-avg1": obj.get("cpu-avg1"),
            "cpu-avg15": obj.get("cpu-avg15"),
            "cpu-avg5": obj.get("cpu-avg5"),
            "cpu-current": obj.get("cpu-current"),
            "cpu-iowait": obj.get("cpu-iowait"),
            "disk-available": obj.get("disk-available"),
            "disk-read": obj.get("disk-read"),
            "disk-total": obj.get("disk-total"),
            "disk-used": obj.get("disk-used"),
            "disk-write": obj.get("disk-write"),
            "mem-total": obj.get("mem-total"),
            "mem-used": obj.get("mem-used"),
            "net-in": obj.get("net-in"),
            "net-out": obj.get("net-out"),
            "swap-total": obj.get("swap-total"),
            "swap-used": obj.get("swap-used"),
            "time": obj.get("time")
        })
        return _obj
