...
class NodesStatusGetStatusResponseDataBootInfo(BaseModel):
    """
    Holds the Bootmodes
    """ # noqa: E501

    mode: PdmNodesStatusModeEnum = Field(description="The possible BootModes")

    secureboot: StrictBool = Field(description="SecureBoot status")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataBootInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataBootInfo from a dict"""
        if obj is None:
            return None
