...
class PveRemotesGetRulesResponseDataInner(BaseModel):
    """
    ...
    log: Optional[PdmLogLevelInEnum] = Field(default=None, description="Firewall log levels.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetRulesResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetRulesResponseDataInner from a dict"""
        if obj is None:
            return None
