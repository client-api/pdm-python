...
class RemotesRemoteGetRrddataResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["metric-collection-response-time", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemotesRemoteGetRrddataResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemotesRemoteGetRrddataResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "metric-collection-response-time": obj.get("metric-collection-response-time"),
            "time": obj.get("time")
        })
        return _obj
