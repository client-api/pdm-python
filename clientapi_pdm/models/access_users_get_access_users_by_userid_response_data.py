...
class AccessUsersGetAccessUsersByUseridResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "email", "enable", "expire", "firstname", "lastname", "userid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessUsersGetAccessUsersByUseridResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessUsersGetAccessUsersByUseridResponseData from a dict"""
        if obj is None:
            return None
