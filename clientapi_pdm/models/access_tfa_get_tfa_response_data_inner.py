...
class AccessTfaGetTfaResponseDataInner(BaseModel):
    """
    ...
    userid: StrictStr = Field(description="The user this entry belongs to.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessTfaGetTfaResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessTfaGetTfaResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "entries": [AccessTfaGetTfaResponseDataInnerEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
