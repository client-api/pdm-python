...
class PbsRemotesCreateTermproxyResponseData(BaseModel):
    """
    ...
    user: StrictStr = Field(description="User that obtained the VNC ticket.")

    __properties: ClassVar[List[str]] = ["port", "ticket", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsRemotesCreateTermproxyResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsRemotesCreateTermproxyResponseData from a dict"""
        if obj is None:
            return None
