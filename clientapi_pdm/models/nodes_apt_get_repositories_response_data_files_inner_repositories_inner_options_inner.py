...
class NodesAptGetRepositoriesResponseDataFilesInnerRepositoriesInnerOptionsInner(BaseModel):
    """
    NodesAptGetRepositoriesResponseDataFilesInnerRepositoriesInnerOptionsInner
    """ # noqa: E501

    key: StrictStr = Field(description="Option key.", alias="Key")

    values: List[StrictStr] = Field(description="Option values.", alias="Values")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesAptGetRepositoriesResponseDataFilesInnerRepositoriesInnerOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesAptGetRepositoriesResponseDataFilesInnerRepositoriesInnerOptionsInner from a dict"""
        if obj is None:
            return None
