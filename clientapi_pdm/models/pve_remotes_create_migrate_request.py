...
class PveRemotesCreateMigrateRequest(BaseModel):
    """
    ...
    online: Optional[StrictBool] = Field(default=None, description="Attempt an online migration if the container is running.")

    restart: Optional[StrictBool] = Field(default=None, description="Perform a restart-migration if the container is running.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesCreateMigrateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesCreateMigrateRequest from a dict"""
        if obj is None:
            return None
