...
class VersionGetVersionResponseData(BaseModel):
    """
    VersionGetVersionResponseData
    """ # noqa: E501

    release: StrictStr = Field(description="The package release.")

    repoid: StrictStr = Field(description="The repoid.")

    version: StrictStr = Field(description="The version string.")

    __properties: ClassVar[List[str]] = ["release", "repoid", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionGetVersionResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionGetVersionResponseData from a dict"""
        if obj is None:
            return None
