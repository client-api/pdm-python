...
class NodesCreateTermproxyRequest(BaseModel):
    """
    NodesCreateTermproxyRequest
    """ # noqa: E501

    cmd: Optional[PdmNodesCmdEnum] = Field(default=None, description="The command to run.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesCreateTermproxyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesCreateTermproxyRequest from a dict"""
        if obj is None:
            return None
