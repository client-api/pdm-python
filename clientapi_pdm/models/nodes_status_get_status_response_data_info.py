...
class NodesStatusGetStatusResponseDataInfo(BaseModel):
    """
    Contains general node information such as the fingerprint`
    """ # noqa: E501

    fingerprint: StrictStr = Field(description="The SSL Fingerprint")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataInfo from a dict"""
        if obj is None:
            return None
