...
class PbsCreateScanResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authid", "id", "nodes", "token", "type", "web-url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsCreateScanResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsCreateScanResponseData from a dict"""
        if obj is None:
            return None
