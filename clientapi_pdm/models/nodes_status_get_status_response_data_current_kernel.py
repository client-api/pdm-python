...
class NodesStatusGetStatusResponseDataCurrentKernel(BaseModel):
    """
    The current kernel version (output of `uname`)
    """ # noqa: E501

    machine: StrictStr = Field(description="The machine architecture")

    release: StrictStr = Field(description="The kernel release number")

    sysname: StrictStr = Field(description="The systemname/nodename")

    version: StrictStr = Field(description="The kernel version")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataCurrentKernel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataCurrentKernel from a dict"""
        if obj is None:
            return None
