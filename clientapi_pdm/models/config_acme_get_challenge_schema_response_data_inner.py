...
class ConfigAcmeGetChallengeSchemaResponseDataInner(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Human readable name, falls back to id.")

    var_schema: Dict[str, Any] = Field(description="The plugin's parameter schema.", alias="schema")

    type: StrictStr = Field(description="Plugin Type.")

    __properties: ClassVar[List[str]] = ["id", "name", "schema", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigAcmeGetChallengeSchemaResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigAcmeGetChallengeSchemaResponseDataInner from a dict"""
        if obj is None:
            return None
