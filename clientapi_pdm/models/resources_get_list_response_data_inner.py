...
class ResourcesGetListResponseDataInner(BaseModel):
    """
    ...
    resources: List[Dict[str, Any]] = Field(description="Array of resources found at this remote.")

    __properties: ClassVar[List[str]] = ["error", "remote", "resources"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourcesGetListResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourcesGetListResponseDataInner from a dict"""
        if obj is None:
            return None
