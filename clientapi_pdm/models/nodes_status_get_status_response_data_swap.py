...
class NodesStatusGetStatusResponseDataSwap(BaseModel):
    """
    Node swap usage counters
    """ # noqa: E501

    free: Annotated[int, Field(strict=True, ge=0)] = Field(description="Free swap")

    total: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total swap")

    used: Annotated[int, Field(strict=True, ge=0)] = Field(description="Used swap")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataSwap from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataSwap from a dict"""
        if obj is None:
            return None
