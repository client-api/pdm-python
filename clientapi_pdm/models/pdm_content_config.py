...
class PdmContentConfig(BaseModel):
    """
    PdmContentConfig
    """ # noqa: E501
    ...
    items: PdmPveRemotesItemsEnum = Field(description="Storage content type.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PdmContentConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PdmContentConfig from a dict"""
        if obj is None:
            return None
