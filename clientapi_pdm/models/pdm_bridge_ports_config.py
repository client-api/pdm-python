...
class PdmBridgePortsConfig(BaseModel):
    """
    ...
    items: Annotated[str, Field(min_length=1, strict=True, max_length=15)] = Field(description="Network interface name.")

    type: Optional[Any]

    __properties: ClassVar[List[str]] = ["description", "items", "type"]



    @field_validator('items')
    def items_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PdmBridgePortsConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PdmBridgePortsConfig from a dict"""
        if obj is None:
            return None
