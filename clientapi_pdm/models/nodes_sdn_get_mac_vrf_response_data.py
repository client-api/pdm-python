...
class NodesSdnGetMacVrfResponseData(BaseModel):
    """
    NodesSdnGetMacVrfResponseData
    """ # noqa: E501

    ip: StrictStr = Field(description="The IP address of the MAC VRF entry.")

    mac: StrictStr = Field(description="The MAC address of the MAC VRF entry.")

    nexthop: StrictStr = Field(description="The IP address of the nexthop.")

    __properties: ClassVar[List[str]] = ["ip", "mac", "nexthop"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesSdnGetMacVrfResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesSdnGetMacVrfResponseData from a dict"""
        if obj is None:
            return None
