...
class PveRemotesGetRrddataResponseDataInner(BaseModel):
    """
    ...
    disk_used: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Current disk utiliziation", alias="disk-used")
    ...
    __properties: ClassVar[List[str]] = ["cpu-current", "cpu-max", "disk-read", "disk-total", "disk-used", "disk-write", "mem-total", "mem-used", "net-in", "net-out", "time", "uptime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetRrddataResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetRrddataResponseDataInner from a dict"""
        if obj is None:
            return None
