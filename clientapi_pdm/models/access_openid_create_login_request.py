...
class AccessOpenidCreateLoginRequest(BaseModel):
    """
    ...
    redirect_url: StrictStr = Field(description="Redirection Url. The client should set this to used server url.", alias="redirect-url")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessOpenidCreateLoginRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessOpenidCreateLoginRequest from a dict"""
        if obj is None:
            return None
