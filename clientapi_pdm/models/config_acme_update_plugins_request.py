...
class ConfigAcmeUpdatePluginsRequest(BaseModel):
    """
    ConfigAcmeUpdatePluginsRequest
    """ # noqa: E501

    api: Optional[StrictStr] = Field(default=None, description="DNS API Plugin Id.")

    data: Optional[StrictStr] = Field(default=None, description="DNS plugin data (base64 encoded with padding).")

    delete: Optional[List[PdmConfigAcmeInlineEnum]] = Field(default=None, description="List of properties to delete.")
    ...
    disable: Optional[StrictBool] = Field(default=False, description="Flag to disable the config.")

    validation_delay: Optional[Annotated[int, Field(le=172800, strict=True, ge=0)]] = Field(default=30, description="Extra delay in seconds to wait before requesting validation.  Allows to cope with long TTL of DNS records.", alias="validation-delay")

    __properties: ClassVar[List[str]] = ["api", "data", "delete", "digest", "disable", "validation-delay"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigAcmeUpdatePluginsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigAcmeUpdatePluginsRequest from a dict"""
        if obj is None:
            return None
