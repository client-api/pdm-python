...
class PdmAcrValuesConfig(BaseModel):
    """
    PdmAcrValuesConfig
    """ # noqa: E501
    ...
    items: Annotated[str, Field(strict=True)] = Field(description="OpenID Authentication Context Class Reference.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PdmAcrValuesConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PdmAcrValuesConfig from a dict"""
        if obj is None:
            return None
