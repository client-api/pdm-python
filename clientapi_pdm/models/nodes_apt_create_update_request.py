...
class NodesAptCreateUpdateRequest(BaseModel):
    """
    NodesAptCreateUpdateRequest
    """ # noqa: E501

    notify: Optional[StrictBool] = Field(default=False, description="Send notification mail about new package updates available to the email address configured for 'root@pam').")

    quiet: Optional[StrictBool] = Field(default=False, description="Only produces output suitable for logging, omitting progress indicators.")

    __properties: ClassVar[List[str]] = ["notify", "quiet"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesAptCreateUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesAptCreateUpdateRequest from a dict"""
        if obj is None:
            return None
