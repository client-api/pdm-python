...
class PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataBootInfo(BaseModel):
    """
    Meta-information about the boot mode.
    """ # noqa: E501

    mode: PdmNodesStatusModeEnum = Field(description="Through which firmware the system got booted.")

    secureboot: Optional[StrictBool] = Field(default=False, description="System is booted in secure mode, only applicable for the \"efi\" mode.")

    __properties: ClassVar[List[str]] = ["mode", "secureboot"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataBootInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataBootInfo from a dict"""
        if obj is None:
            return None
