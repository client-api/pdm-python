...
class AccessUsersUpdateTokenRequest(BaseModel):
    """
    ...
    delete: Optional[List[PdmAccessUsersInlineEnum2]] = Field(default=None, description="List of properties to delete.")
    ...
    regenerate: Optional[StrictBool] = Field(default=False, description="Regenerate token secret while keeping permissions.")

    __properties: ClassVar[List[str]] = ["comment", "delete", "digest", "enable", "expire", "regenerate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessUsersUpdateTokenRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessUsersUpdateTokenRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "regenerate": obj.get("regenerate") if obj.get("regenerate") is not None else False
        })
        return _obj
