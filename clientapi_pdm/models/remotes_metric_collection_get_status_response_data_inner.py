...
class RemotesMetricCollectionGetStatusResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["error", "last-collection", "remote"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemotesMetricCollectionGetStatusResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemotesMetricCollectionGetStatusResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "last-collection": obj.get("last-collection"),
