...
class PveRemotesGetMigrateResponseDataLocalDisksInner(BaseModel):
    """
    PveRemotesGetMigrateResponseDataLocalDisksInner
    """ # noqa: E501

    cdrom: StrictBool = Field(description="True if the disk is a cdrom.")
    ...
    __properties: ClassVar[List[str]] = ["cdrom", "is_unused", "size", "volid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetMigrateResponseDataLocalDisksInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetMigrateResponseDataLocalDisksInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cdrom": obj.get("cdrom") if obj.get("cdrom") is not None else False,
            "is_unused": obj.get("is_unused") if obj.get("is_unused") is not None else False,
            "size": obj.get("size"),
            "volid": obj.get("volid")
        })
        return _obj
