...
class AccessGetRolesResponseDataInner(BaseModel):
    """
    ...
    privs: List[StrictStr] = Field(description="List of Privileges")

    roleid: StrictStr = Field(description="The id of the role")

    __properties: ClassVar[List[str]] = ["comment", "privs", "roleid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessGetRolesResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessGetRolesResponseDataInner from a dict"""
        if obj is None:
            return None
