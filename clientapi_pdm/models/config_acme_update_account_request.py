...
class ConfigAcmeUpdateAccountRequest(BaseModel):
    """
    ConfigAcmeUpdateAccountRequest
    """ # noqa: E501

    contact: Optional[StrictStr] = Field(default=None, description="List of email addresses.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigAcmeUpdateAccountRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigAcmeUpdateAccountRequest from a dict"""
        if obj is None:
            return None
