...
class PdmPropertiesConfig(BaseModel):
    """
    PdmPropertiesConfig
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "enum", "optional", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PdmPropertiesConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PdmPropertiesConfig from a dict"""
        if obj is None:
            return None
