...
class NodesSubscriptionGetSubscriptionResponseData(BaseModel):
    ...
    status: PdmStatusEnum = Field(description="Subscription status")

    url: Optional[StrictStr] = Field(default=None, description="URL to the web shop")

    __properties: ClassVar[List[str]] = ["checktime", "key", "message", "nextduedate", "productname", "regdate", "serverid", "signature", "status", "url"]
