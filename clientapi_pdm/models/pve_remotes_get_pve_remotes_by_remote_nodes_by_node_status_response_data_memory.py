...
class PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataMemory(BaseModel):
    """
    Object.
    """ # noqa: E501

    available: Optional[StrictInt] = Field(default=None, description="The available memory in bytes.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataMemory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataMemory from a dict"""
        if obj is None:
            return None
