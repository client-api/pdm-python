...
class NodesStatusGetStatusResponseDataCpuinfo(BaseModel):
    """
    Information about the CPU
    """ # noqa: E501

    cpus: Annotated[int, Field(strict=True, ge=0)] = Field(description="The number of CPU cores (incl. threads)")

    model: StrictStr = Field(description="The CPU model")

    sockets: Annotated[int, Field(strict=True, ge=0)] = Field(description="The number of CPU sockets")

    __properties: ClassVar[List[str]] = ["cpus", "model", "sockets"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataCpuinfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesStatusGetStatusResponseDataCpuinfo from a dict"""
        if obj is None:
            return None
