...
class NodesCertificatesCreateCustomResponseDataInner(BaseModel):
    """
    NodesCertificatesCreateCustomResponseDataInner
    """ # noqa: E501

    filename: StrictStr = Field(description="Certificate file name.")

    fingerprint: Optional[StrictStr] = Field(default=None, description="The SSL Fingerprint.")
    ...
    public_key_bits: Optional[Annotated[int, Field(le=4294967295, strict=True, ge=0)]] = Field(default=None, description="Certificate's public key size if available.", alias="public-key-bits")

    public_key_type: StrictStr = Field(description="Certificate's public key algorithm.", alias="public-key-type")

    san: List[StrictStr] = Field(description="List of certificate's SubjectAlternativeName entries.")

    subject: StrictStr = Field(description="Certificate subject name.")

    __properties: ClassVar[List[str]] = ["filename", "fingerprint", "issuer", "notafter", "notbefore", "pem", "public-key-bits", "public-key-type", "san", "subject"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesCertificatesCreateCustomResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesCertificatesCreateCustomResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pem": obj.get("pem"),
            "public-key-bits": obj.get("public-key-bits"),
            "public-key-type": obj.get("public-key-type"),
            "san": obj.get("san"),
