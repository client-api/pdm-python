...
class AccessAclUpdateAclRequest(BaseModel):
    """
    AccessAclUpdateAclRequest
    """ # noqa: E501

    auth_id: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=64)]] = Field(default=None, description="Authentication ID", alias="auth-id")

    delete: Optional[StrictBool] = Field(default=False, description="Remove permissions (instead of adding it).")
    ...
    group: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=64)]] = Field(default=None, description="Group ID")
    ...
    __properties: ClassVar[List[str]] = ["auth-id", "delete", "digest", "group", "path", "propagate", "role"]


    @field_validator('auth_id')
    def auth_id_validate_regular_expression(cls, value):
    ...
    def group_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(?:[^\s:/\x00-\x1f\x7f]+)$", value):
            raise ValueError(r"must validate the regular expression /^(?:[^\s:/\x00-\x1f\x7f]+)$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAclUpdateAclRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAclUpdateAclRequest from a dict"""
        if obj is None:
            return None
