...
class NodesTasksGetLogResponseDataData(BaseModel):
    """
    A line of a task log.
    """ # noqa: E501

    n: Annotated[int, Field(strict=True, ge=0)] = Field(description="Line number.")

    t: StrictStr = Field(description="The line of the log.")

    __properties: ClassVar[List[str]] = ["n", "t"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesTasksGetLogResponseDataData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesTasksGetLogResponseDataData from a dict"""
        if obj is None:
            return None
