...
class PbsRemotesGetRrddataResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["disk-available", "disk-read", "disk-total", "disk-used", "disk-write", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsRemotesGetRrddataResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsRemotesGetRrddataResponseDataInner from a dict"""
        if obj is None:
            return None
