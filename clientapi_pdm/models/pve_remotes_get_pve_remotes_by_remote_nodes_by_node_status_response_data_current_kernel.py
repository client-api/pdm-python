...
class PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataCurrentKernel(BaseModel):
    """
    Meta-information about the currently booted kernel of this node.
    """ # noqa: E501

    machine: StrictStr = Field(description="Hardware (architecture) type")

    release: StrictStr = Field(description="OS kernel release (e.g., \"6.8.0\")")

    sysname: StrictStr = Field(description="OS kernel name (e.g., \"Linux\")")

    version: StrictStr = Field(description="OS kernel version with build info")

    __properties: ClassVar[List[str]] = ["machine", "release", "sysname", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataCurrentKernel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetPveRemotesByRemoteNodesByNodeStatusResponseDataCurrentKernel from a dict"""
        if obj is None:
            return None
