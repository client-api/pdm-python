...
class NodesAptUpdateRepositoriesRequest(BaseModel):
    """
    ...
    handle: PdmNodesAptHandleEnum = Field(description="Handles for Proxmox repositories.")

    __properties: ClassVar[List[str]] = ["digest", "handle"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesAptUpdateRepositoriesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesAptUpdateRepositoriesRequest from a dict"""
        if obj is None:
            return None
