...
class PbsRemotesGetSnapshotsResponseDataInnerVerification(BaseModel):
    """
    Task properties.
    """ # noqa: E501

    state: PdmPbsRemotesStateEnum = Field(description="Result of a verify operation.")

    upid: Annotated[str, Field(min_length=36, strict=True)] = Field(description="Unique Process/Task Identifier")

    __properties: ClassVar[List[str]] = ["state", "upid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsRemotesGetSnapshotsResponseDataInnerVerification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsRemotesGetSnapshotsResponseDataInnerVerification from a dict"""
        if obj is None:
            return None
