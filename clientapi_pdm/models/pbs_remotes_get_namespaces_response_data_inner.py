...
class PbsRemotesGetNamespacesResponseDataInner(BaseModel):
    """
    PbsRemotesGetNamespacesResponseDataInner
    """ # noqa: E501

    comment: Optional[StrictStr] = Field(default=None, description="The first line from the namespace's \"notes\"")

    ns: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Namespace.")

    __properties: ClassVar[List[str]] = ["comment", "ns"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsRemotesGetNamespacesResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsRemotesGetNamespacesResponseDataInner from a dict"""
        if obj is None:
            return None
