...
class RemotesRemoteUpdateRemoteRequest(BaseModel):
    """
    RemotesRemoteUpdateRemoteRequest
    """ # noqa: E501

    authid: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=64)]] = Field(default=None, description="Authentication ID")

    delete: Optional[List[PdmRemotesRemoteInlineEnum]] = Field(default=None, description="List of properties to delete.")
    ...
    nodes: Optional[List[StrictStr]] = Field(default=None, description="A list of cluster node addresses.")

    token: Optional[StrictStr] = Field(default=None, description="The access token's secret.")

    web_url: Optional[StrictStr] = Field(default=None, description="Configuration for the Web UI URL link generation.", alias="web-url")

    __properties: ClassVar[List[str]] = ["authid", "delete", "digest", "nodes", "token", "web-url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemotesRemoteUpdateRemoteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemotesRemoteUpdateRemoteRequest from a dict"""
        if obj is None:
            return None
