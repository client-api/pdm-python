...
class PveRemotesGetTasksResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["endtime", "id", "node", "pid", "pstart", "starttime", "status", "type", "upid", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesGetTasksResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesGetTasksResponseDataInner from a dict"""
        if obj is None:
            return None
