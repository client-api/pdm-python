...
class ConfigAcmeGetAccountResponseDataInner(BaseModel):
    """
    ConfigAcmeGetAccountResponseDataInner
    """ # noqa: E501

    name: Annotated[str, Field(strict=True)] = Field(description="ACME account name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigAcmeGetAccountResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigAcmeGetAccountResponseDataInner from a dict"""
        if obj is None:
            return None
