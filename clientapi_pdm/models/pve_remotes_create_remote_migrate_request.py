...
class PveRemotesCreateRemoteMigrateRequest(BaseModel):
    """
    ...
    restart: Optional[StrictBool] = Field(default=None, description="Perform a restart-migration.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRemotesCreateRemoteMigrateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRemotesCreateRemoteMigrateRequest from a dict"""
        if obj is None:
            return None
