...
class AccessUsersGetUsersResponseDataInner(BaseModel):
    """
    ...
    firstname: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="First name.")
    ...
    totp_locked: Optional[StrictBool] = Field(default=False, description="True if the user is currently locked out of TOTP factors", alias="totp-locked")

    userid: Annotated[str, Field(min_length=3, strict=True, max_length=64)] = Field(description="User ID")

    __properties: ClassVar[List[str]] = ["comment", "email", "enable", "expire", "firstname", "lastname", "tfa-locked-until", "tokens", "totp-locked", "userid"]
    ...
    def firstname_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def lastname_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessUsersGetUsersResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessUsersGetUsersResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tokens": [AccessUsersGetUsersResponseDataInnerTokensInner.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
            "totp-locked": obj.get("totp-locked") if obj.get("totp-locked") is not None else False,
