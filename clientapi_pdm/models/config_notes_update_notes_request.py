...
class ConfigNotesUpdateNotesRequest(BaseModel):
    """
    ...
    notes: StrictStr = Field(description="New notes text.")

    __properties: ClassVar[List[str]] = ["digest", "notes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigNotesUpdateNotesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigNotesUpdateNotesRequest from a dict"""
        if obj is None:
            return None
