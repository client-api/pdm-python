...
class PbsRemotesGetPbsRemotesByRemoteTasksByUpidStatusResponseData(BaseModel):
    """
    PbsRemotesGetPbsRemotesByRemoteTasksByUpidStatusResponseData
    """ # noqa: E501

    exitstatus: Optional[StrictStr] = Field(default=None, description="Exit status, if available.")

    id: Optional[StrictStr] = Field(default=None, description="Task id.")
    ...
    type: StrictStr = Field(description="The task type.")

    upid: StrictStr = Field(description="The task's UPID.")

    user: StrictStr = Field(description="The authenticated entity who started the task.")

    __properties: ClassVar[List[str]] = ["exitstatus", "id", "node", "pid", "pstart", "starttime", "status", "type", "upid", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PbsRemotesGetPbsRemotesByRemoteTasksByUpidStatusResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PbsRemotesGetPbsRemotesByRemoteTasksByUpidStatusResponseData from a dict"""
        if obj is None:
            return None
