...
class AccessTfaCreateTfaResponseData(BaseModel):
    """
    AccessTfaCreateTfaResponseData
    """ # noqa: E501

    challenge: Optional[StrictStr] = Field(default=None, description="When adding u2f entries, this contains a challenge the user must respond to in order to finish the registration.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessTfaCreateTfaResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessTfaCreateTfaResponseData from a dict"""
        if obj is None:
            return None
