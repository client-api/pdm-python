...
class AccessUsersUpdateUsersRequest(BaseModel):
    """
    ...
    delete: Optional[List[PdmAccessUsersInlineEnum]] = Field(default=None, description="List of properties to delete.")
    ...
    password: Optional[Annotated[str, Field(min_length=8, strict=True, max_length=64)]] = Field(default=None, description="User Password.")

    __properties: ClassVar[List[str]] = ["comment", "delete", "digest", "email", "enable", "expire", "firstname", "lastname", "password"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessUsersUpdateUsersRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessUsersUpdateUsersRequest from a dict"""
        if obj is None:
            return None
